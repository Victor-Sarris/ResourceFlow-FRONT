...
import { IoArrowBackSharp, IoHomeOutline, IoCalendarOutline, IoHelpCircleOutline, IoLogOutOutline, IoMenu } from "react-icons/io5"; // Adicionei o IoMenu
            ...
            `}>
                ...
                <div className="p-8 flex flex-col gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-slate-400 mt-1">Gerenciamento de Eventos</p>
                    </div>
                </div>

                <nav className="flex-1 px-4 flex flex-col gap-2">
                    <MenuButton icon={<IoHomeOutline size={20} />} text="Home" active />
                    <MenuButton icon={<IoCalendarOutline size={20} />} text="Agenda" />
                    <MenuButton icon={<IoHelpCircleOutline size={20} />} text="Suporte" />
                    <MenuButton icon={<CgProfile size={20} />} text="Perfil" />
                </nav>
...
function MenuButton({ icon, text, active = false }) {
    return (
        <button 
            className={`
