    ...
    return (
        <div className="flex min-h-screen bg-slate-950">
            ...
            <main className="flex-1 lg:ml-64 p-8 transition-all duration-300">
                    ...
                    <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between relative z-10">
                        <div className="lg:w-2/3 text-center lg:text-left animate-fade-in-up">
                            ...
                            <p className="text-xl opacity-90 mb-8 max-w-2xl mx-auto lg:mx-0">
                                Obtenha suporte instantâneo para suas necessidades na plataforma Resource Flow.
                            </p>
                ...
                <div className="bg-slate-800 w-full text-white p-6 flex flex-col gap-6 rounded-3xl mt-6 shadow-2xl overflow-hidden px-4 sm:px-6 lg:px-8 relative">
                        <h1 className="text-3xl text-red-600 font-bold">ATENÇÃO</h1>
                        <p>Todas as respostas são dadas por uma IA especializada no contexto geral da plataforma. Caso queira uma resposta mais específica, entre em contato com: <a href="https://mail.google.com/mail/u/0/#drafts?compose=CllgCJNsvFMVbsLZPCknDKDCPbphhzgfXLFWhZpVDRwLbGVrRRrRgNFsptcxmdKCNRBkGFDdLqB" className="text-blue-600">devvictorsarris@gmail.com</a></p>
                    </div>
                {!isChatbotOpen && (
                    <button
                ...
                {isChatbotOpen && (
                    <div className="fixed bottom-24 right-8 w-80 md:w-96 bg-slate-900 border border-slate-700 rounded-2xl shadow-2xl z-50 flex flex-col overflow-hidden animate-fade-in-up">
                        ...
                        <div className="bg-gradient-to-r from-purple-800 to-indigo-800 p-4 flex justify-between items-center">
                            ...
                            <button onClick={toggleChatbot} className="text-white/80 hover:text-white hover:bg-white/10 rounded-full p-1 transition-colors">
                                <IoClose size={20} />
                            </button>
                        </div>
